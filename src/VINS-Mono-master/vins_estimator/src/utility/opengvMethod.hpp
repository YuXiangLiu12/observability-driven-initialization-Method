...
namespace opengv {
    ...
    static Eigen::Matrix<T, 3, 3> ComposeMwithJacobians(
            const Eigen::Matrix<T, 3, 3> &xxF,
            const Eigen::Matrix<T, 3, 3> &yyF,
            const Eigen::Matrix<T, 3, 3> &zzF,
            const Eigen::Matrix<T, 3, 3> &xyF,
            const Eigen::Matrix<T, 3, 3> &yzF,
            const Eigen::Matrix<T, 3, 3> &zxF,
        ...
        temp = R.row(2) * yyF.template cast<T>() * R.row(2).transpose();
        M(0, 0) = temp(0, 0);
        temp = T(-2.0) * R.row(2) * yzF.template cast<T>() * R.row(1).transpose();
        M(0, 0) += temp(0, 0);
        temp = R.row(1) * zzF.template cast<T>() * R.row(1).transpose();
        M(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(2) * yyF.template cast<T>() * R.row(2).transpose();
        M_jac1(0, 0) = temp(0, 0);
        temp = T(-2.0) * R_jac1.row(2) * yzF.template cast<T>() * R.row(1).transpose();
        M_jac1(0, 0) += temp(0, 0);
        temp = T(-2.0) * R.row(2) * yzF.template cast<T>() * R_jac1.row(1).transpose();
        M_jac1(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(1) * zzF.template cast<T>() * R.row(1).transpose();
        M_jac1(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(2) * yyF.template cast<T>() * R.row(2).transpose();
        M_jac2(0, 0) = temp(0, 0);
        temp = T(-2.0) * R_jac2.row(2) * yzF.template cast<T>() * R.row(1).transpose();
        M_jac2(0, 0) += temp(0, 0);
        temp = T(-2.0) * R.row(2) * yzF.template cast<T>() * R_jac2.row(1).transpose();
        M_jac2(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(1) * zzF.template cast<T>() * R.row(1).transpose();
        M_jac2(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(2) * yyF.template cast<T>() * R.row(2).transpose();
        M_jac3(0, 0) = temp(0, 0);
        temp = T(-2.0) * R_jac3.row(2) * yzF.template cast<T>() * R.row(1).transpose();
        M_jac3(0, 0) += temp(0, 0);
        temp = T(-2.0) * R.row(2) * yzF.template cast<T>() * R_jac3.row(1).transpose();
        M_jac3(0, 0) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(1) * zzF.template cast<T>() * R.row(1).transpose();
        M_jac3(0, 0) += temp(0, 0);

        temp = R.row(2) * yzF.template cast<T>() * R.row(0).transpose();
        M(0, 1) = temp(0, 0);
        temp = T(-1.0) * R.row(2) * xyF.template cast<T>() * R.row(2).transpose();
        M(0, 1) += temp(0, 0);
        temp = T(-1.0) * R.row(1) * zzF.template cast<T>() * R.row(0).transpose();
        M(0, 1) += temp(0, 0);
        temp = R.row(1) * zxF.template cast<T>() * R.row(2).transpose();
        M(0, 1) += temp(0, 0);
        temp = R_jac1.row(2) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac1(0, 1) = temp(0, 0);
        temp = R.row(2) * yzF.template cast<T>() * R_jac1.row(0).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = T(-2.0) * R_jac1.row(2) * xyF.template cast<T>() * R.row(2).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = T(-1.0) * R_jac1.row(1) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = T(-1.0) * R.row(1) * zzF.template cast<T>() * R_jac1.row(0).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = R_jac1.row(1) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = R.row(1) * zxF.template cast<T>() * R_jac1.row(2).transpose();
        M_jac1(0, 1) += temp(0, 0);
        temp = R_jac2.row(2) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac2(0, 1) = temp(0, 0);
        temp = R.row(2) * yzF.template cast<T>() * R_jac2.row(0).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = T(-2.0) * R_jac2.row(2) * xyF.template cast<T>() * R.row(2).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = T(-1.0) * R_jac2.row(1) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = T(-1.0) * R.row(1) * zzF.template cast<T>() * R_jac2.row(0).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = R_jac2.row(1) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = R.row(1) * zxF.template cast<T>() * R_jac2.row(2).transpose();
        M_jac2(0, 1) += temp(0, 0);
        temp = R_jac3.row(2) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac3(0, 1) = temp(0, 0);
        temp = R.row(2) * yzF.template cast<T>() * R_jac3.row(0).transpose();
        M_jac3(0, 1) += temp(0, 0);
        temp = T(-2.0) * R_jac3.row(2) * xyF.template cast<T>() * R.row(2).transpose();
        M_jac3(0, 1) += temp(0, 0);
        temp = T(-1.0) * R_jac3.row(1) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac3(0, 1) += temp(0, 0);
        temp = T(-1.0) * R.row(1) * zzF.template cast<T>() * R_jac3.row(0).transpose();
        M_jac3(0, 1) += temp(0, 0);
        temp = R_jac3.row(1) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac3(0, 1) += temp(0, 0);
        temp = R.row(1) * zxF.template cast<T>() * R_jac3.row(2).transpose();
        M_jac3(0, 1) += temp(0, 0);

        temp = R.row(2) * xyF.template cast<T>() * R.row(1).transpose();
        M(0, 2) = temp(0, 0);
        temp = T(-1.0) * R.row(2) * yyF.template cast<T>() * R.row(0).transpose();
        M(0, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(1) * zxF.template cast<T>() * R.row(1).transpose();
        M(0, 2) += temp(0, 0);
        temp = R.row(1) * yzF.template cast<T>() * R.row(0).transpose();
        M(0, 2) += temp(0, 0);
        temp = R_jac1.row(2) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac1(0, 2) = temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac1.row(1).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac1.row(2) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * yyF.template cast<T>() * R_jac1.row(0).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac1.row(1) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = R_jac1.row(1) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = R.row(1) * yzF.template cast<T>() * R_jac1.row(0).transpose();
        M_jac1(0, 2) += temp(0, 0);
        temp = R_jac2.row(2) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac2(0, 2) = temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac2.row(1).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac2.row(2) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * yyF.template cast<T>() * R_jac2.row(0).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac2.row(1) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = R_jac2.row(1) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = R.row(1) * yzF.template cast<T>() * R_jac2.row(0).transpose();
        M_jac2(0, 2) += temp(0, 0);
        temp = R_jac3.row(2) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac3(0, 2) = temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac3.row(1).transpose();
        M_jac3(0, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac3.row(2) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac3(0, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * yyF.template cast<T>() * R_jac3.row(0).transpose();
        M_jac3(0, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac3.row(1) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac3(0, 2) += temp(0, 0);
        temp = R_jac3.row(1) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac3(0, 2) += temp(0, 0);
        temp = R.row(1) * yzF.template cast<T>() * R_jac3.row(0).transpose();
        M_jac3(0, 2) += temp(0, 0);

        temp = R.row(0) * zzF.template cast<T>() * R.row(0).transpose();
        M(1, 1) = temp(0, 0);
        temp = T(-2.0) * R.row(0) * zxF.template cast<T>() * R.row(2).transpose();
        M(1, 1) += temp(0, 0);
        temp = R.row(2) * xxF.template cast<T>() * R.row(2).transpose();
        M(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(0) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac1(1, 1) = temp(0, 0);
        temp = T(-2.0) * R_jac1.row(0) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac1(1, 1) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * zxF.template cast<T>() * R_jac1.row(2).transpose();
        M_jac1(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(2) * xxF.template cast<T>() * R.row(2).transpose();
        M_jac1(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(0) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac2(1, 1) = temp(0, 0);
        temp = T(-2.0) * R_jac2.row(0) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac2(1, 1) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * zxF.template cast<T>() * R_jac2.row(2).transpose();
        M_jac2(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(2) * xxF.template cast<T>() * R.row(2).transpose();
        M_jac2(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(0) * zzF.template cast<T>() * R.row(0).transpose();
        M_jac3(1, 1) = temp(0, 0);
        temp = T(-2.0) * R_jac3.row(0) * zxF.template cast<T>() * R.row(2).transpose();
        M_jac3(1, 1) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * zxF.template cast<T>() * R_jac3.row(2).transpose();
        M_jac3(1, 1) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(2) * xxF.template cast<T>() * R.row(2).transpose();
        M_jac3(1, 1) += temp(0, 0);

        temp = R.row(0) * zxF.template cast<T>() * R.row(1).transpose();
        M(1, 2) = temp(0, 0);
        temp = T(-1.0) * R.row(0) * yzF.template cast<T>() * R.row(0).transpose();
        M(1, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * xxF.template cast<T>() * R.row(1).transpose();
        M(1, 2) += temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R.row(0).transpose();
        M(1, 2) += temp(0, 0);
        temp = R_jac1.row(0) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac1(1, 2) = temp(0, 0);
        temp = R.row(0) * zxF.template cast<T>() * R_jac1.row(1).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac1.row(0) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac1.row(2) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * xxF.template cast<T>() * R_jac1.row(1).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = R_jac1.row(2) * xyF.template cast<T>() * R.row(0).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac1.row(0).transpose();
        M_jac1(1, 2) += temp(0, 0);
        temp = R_jac2.row(0) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac2(1, 2) = temp(0, 0);
        temp = R.row(0) * zxF.template cast<T>() * R_jac2.row(1).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac2.row(0) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac2.row(2) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * xxF.template cast<T>() * R_jac2.row(1).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = R_jac2.row(2) * xyF.template cast<T>() * R.row(0).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac2.row(0).transpose();
        M_jac2(1, 2) += temp(0, 0);
        temp = R_jac3.row(0) * zxF.template cast<T>() * R.row(1).transpose();
        M_jac3(1, 2) = temp(0, 0);
        temp = R.row(0) * zxF.template cast<T>() * R_jac3.row(1).transpose();
        M_jac3(1, 2) += temp(0, 0);
        temp = T(-2.0) * R_jac3.row(0) * yzF.template cast<T>() * R.row(0).transpose();
        M_jac3(1, 2) += temp(0, 0);
        temp = T(-1.0) * R_jac3.row(2) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac3(1, 2) += temp(0, 0);
        temp = T(-1.0) * R.row(2) * xxF.template cast<T>() * R_jac3.row(1).transpose();
        M_jac3(1, 2) += temp(0, 0);
        temp = R_jac3.row(2) * xyF.template cast<T>() * R.row(0).transpose();
        M_jac3(1, 2) += temp(0, 0);
        temp = R.row(2) * xyF.template cast<T>() * R_jac3.row(0).transpose();
        M_jac3(1, 2) += temp(0, 0);

        temp = R.row(1) * xxF.template cast<T>() * R.row(1).transpose();
        M(2, 2) = temp(0, 0);
        temp = T(-2.0) * R.row(0) * xyF.template cast<T>() * R.row(1).transpose();
        M(2, 2) += temp(0, 0);
        temp = R.row(0) * yyF.template cast<T>() * R.row(0).transpose();
        M(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(1) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac1(2, 2) = temp(0, 0);
        temp = T(-2.0) * R_jac1.row(0) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac1(2, 2) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * xyF.template cast<T>() * R_jac1.row(1).transpose();
        M_jac1(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac1.row(0) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac1(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(1) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac2(2, 2) = temp(0, 0);
        temp = T(-2.0) * R_jac2.row(0) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac2(2, 2) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * xyF.template cast<T>() * R_jac2.row(1).transpose();
        M_jac2(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac2.row(0) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac2(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(1) * xxF.template cast<T>() * R.row(1).transpose();
        M_jac3(2, 2) = temp(0, 0);
        temp = T(-2.0) * R_jac3.row(0) * xyF.template cast<T>() * R.row(1).transpose();
        M_jac3(2, 2) += temp(0, 0);
        temp = T(-2.0) * R.row(0) * xyF.template cast<T>() * R_jac3.row(1).transpose();
        M_jac3(2, 2) += temp(0, 0);
        temp = T(2.0) * R_jac3.row(0) * yyF.template cast<T>() * R.row(0).transpose();
        M_jac3(2, 2) += temp(0, 0);
    ...
    static T GetSmallestEVwithJacobian(
        ...
        T c =
                ...
                M(0, 0) * M(1, 1) + M(0, 0) * M(2, 2) + M(1, 1) * M(2, 2);
        T c_jac1 =
                T(-2.0) * M(0, 2) * M_jac1(0, 2) - T(2.0) * M(1, 2) * M_jac1(1, 2) - T(2.0) * M(0, 1) * M_jac1(0, 1)
                + M_jac1(0, 0) * M(1, 1) + M(0, 0) * M_jac1(1, 1) + M_jac1(0, 0) * M(2, 2)
                + M(0, 0) * M_jac1(2, 2) + M_jac1(1, 1) * M(2, 2) + M(1, 1) * M_jac1(2, 2);
        T c_jac2 =
                T(-2.0) * M(0, 2) * M_jac2(0, 2) - T(2.0) * M(1, 2) * M_jac2(1, 2) - T(2.0) * M(0, 1) * M_jac2(0, 1)
                + M_jac2(0, 0) * M(1, 1) + M(0, 0) * M_jac2(1, 1) + M_jac2(0, 0) * M(2, 2)
                + M(0, 0) * M_jac2(2, 2) + M_jac2(1, 1) * M(2, 2) + M(1, 1) * M_jac2(2, 2);
        T c_jac3 =
                T(-2.0) * M(0, 2) * M_jac3(0, 2) - T(2.0) * M(1, 2) * M_jac3(1, 2) - T(2.0) * M(0, 1) * M_jac3(0, 1)
                + M_jac3(0, 0) * M(1, 1) + M(0, 0) * M_jac3(1, 1) + M_jac3(0, 0) * M(2, 2)
                + M(0, 0) * M_jac3(2, 2) + M_jac3(1, 1) * M(2, 2) + M(1, 1) * M_jac3(2, 2);
        T d =
        ...
        T d_jac1 =
                ...
                + M_jac1(0, 0) * ceres::pow(M(1, 2), 2) + M(0, 0) * T(2.0) * M(1, 2) * M_jac1(1, 2)
                + M_jac1(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * T(2.0) * M(0, 1) * M_jac1(0, 1)
                - M_jac1(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac1(1, 1) * M(2, 2)
        ...
        T d_jac2 =
                ...
                + M_jac2(0, 0) * ceres::pow(M(1, 2), 2) + M(0, 0) * T(2.0) * M(1, 2) * M_jac2(1, 2)
                + M_jac2(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * T(2.0) * M(0, 1) * M_jac2(0, 1)
                - M_jac2(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac2(1, 1) * M(2, 2)
        ...
        T d_jac3 =
                ...
                + M_jac3(2, 2) * ceres::pow(M(0, 1), 2) + M(2, 2) * T(2.0) * M(0, 1) * M_jac3(0, 1)
                - M_jac3(0, 0) * M(1, 1) * M(2, 2) - M(0, 0) * M_jac3(1, 1) * M(2, 2)
